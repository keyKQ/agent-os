...
@pytest.mark.parametrize(
    ...
    [
        ...
        # A flag that takes no value must not swallow the wrapped command's
        # first word and leave its second word to be read as the command.
        "import os; os.system(\"bash -c 'git rm --cached x'\")",
        "import os; os.system(\"sh -c 'cat rm'\")",
        "import os; os.system(\"bash -c 'grep rm file'\")",
