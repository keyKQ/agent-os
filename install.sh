...
default_version="v2026.9.22.post1"
...
usage() {
    cat <<HELP
Usage: bash install.sh [--version v2026.9.22.post1|latest] [--profile recommended|core] [--extras name[,name]]
       bash install.sh --manifest
       bash install.sh --stage <name> [--json] [--non-interactive]

Environment equivalents:
  AGENTOS_VERSION=v2026.9.22.post1
