...
def standalone_slash_services_from_runtime(
    ...
    update_session = (
        getattr(session_manager, "update", None)
        if session_manager is not None
        else None
    )
    truncate_session = (
    ...
    update_session_callable = (
        cast(_standalone_slash_adapter.StandaloneUpdateSession, update_session)
    ...
    return _standalone_slash_adapter.StandaloneSlashServices(
        ...
        update_session=update_session_callable,
