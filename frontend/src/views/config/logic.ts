...
function helpMap(): Record<string, string> {
  return {
    ...
    'agentos_router.jev.api_key': t('config.helpAgentosRouterJevApiKey'),
    'agentos_router.jev.api_key_env': t('config.helpAgentosRouterJevApiKeyEnv'),
    'agentos_router.jev.base_url': t('config.helpAgentosRouterJevBaseUrl'),
    'agentos_router.jev.model': t('config.helpAgentosRouterJevModel'),
    'agentos_router.jev.input_max_chars': t('config.helpAgentosRouterJevInputMaxChars'),
    'agentos_router.jev.high_risk_threshold': t('config.helpAgentosRouterJevHighRiskThreshold'),
    'agentos_router.jev.timeout_seconds': t('config.helpAgentosRouterJevTimeoutSeconds'),
    'agentos_router.jev.short_circuit_enabled': t('config.helpAgentosRouterJevShortCircuitEnabled'),
    'agentos_router.jev.agentic_floor_enabled': t('config.helpAgentosRouterJevAgenticFloorEnabled'),
