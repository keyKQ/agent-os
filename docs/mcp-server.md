...
Install AgentOS with the MCP extra when you need this bridge:

```sh
uv tool install --python 3.12 "agentos[recommended,mcp] @ https://github.com/use-agent-os/agent-os/releases/download/v0.0.1/agentos-0.0.1-py3-none-any.whl"
```
